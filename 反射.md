...
*  Class类的实例对象表示正在运行的 Java 应用程序中的类和接口。也就是jvm中有N多的实例，每个类都有唯一的Class对象。（包括基本数据类型）
...
```text
className = com.practice.reflect.property.Student
methodName = show
```
...
2.https://blog.csdn.net/lililuni/article/details/83449088